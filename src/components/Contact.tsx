        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full flex justify-center items-center gap-2 px-6 py-3.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-black font-extrabold text-xs tracking-widest uppercase transition-all shadow-lg shadow-amber-500/20 active:scale-[0.98] cursor-pointer"
              >
                Send Message
