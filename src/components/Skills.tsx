            ...
            <div className="flex gap-4 shrink-0 animate-marquee-left">
              {[...creativeTools, ...creativeTools].map((tool, idx) => (
                <div
                  ...
                  className="flex items-center gap-2 md:gap-3 px-4 py-2.5 md:px-6 md:py-3.5 rounded-full bg-[#161618]/90 border border-white/[0.08] hover:border-amber-500/30 hover:bg-[#1c1c1f]/90 hover:shadow-[0_0_20px_rgba(245,158,11,0.12)] transition-all duration-300 group cursor-default shadow-[0_4px_12px_rgba(0,0,0,0.5)]"
                >
                  <div className="flex items-center justify-center w-5 h-5 shrink-0 transition-transform duration-300 group-hover:scale-110">
                    {tool.icon}
                  </div>
                  <span className="text-xs md:text-sm font-semibold tracking-wide text-neutral-300 group-hover:text-white transition-colors duration-200">
                    {tool.name}
                  </span>
                </div>
              ))}
